...
plotCorToOne <- function(inputDf, referenceVar, nameY = "Correlation Coefficient", nameX = "External Measures"){
  ...
  corDf %>% 
    ...
    ylab(nameY) +
    xlab(nameX) + theme_grey(base_size = 9)  + theme(axis.text.x = element_text(angle = 90,hjust = 1)) +
